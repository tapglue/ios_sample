...
@property (nonatomic, readonly, strong) id _Nonnull appEventParameterValue;
@end
...
SWIFT_CLASS("_TtC12FacebookCore22UserProfilePictureView")
@interface UserProfilePictureView : UIView
...
@interface UserProfilePictureView (SWIFT_EXTENSION(FacebookCore))
@end
