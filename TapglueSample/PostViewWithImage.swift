...
class PostViewWithImage: UIView {
...
//                })
    ...
    func createTagBtns(tagsCount: Int, tags: [String]) {
        ...
        for tag in tags {
            ...
            button.addTarget(self, action: #selector(PostViewWithImage.action(_:)), forControlEvents: UIControlEvents.TouchUpInside)
    ...
    func loadViewFromNib() -> UIView {
        ...
        let nib = UINib(nibName: "PostViewWithImage", bundle: bundle)
        
        // Assumes PostViewWithImageUIView is top level and only object in CustomView.xib file
